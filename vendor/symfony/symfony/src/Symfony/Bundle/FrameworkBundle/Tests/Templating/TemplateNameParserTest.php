...
class TemplateNameParserTest extends TestCase
{
    ...
    {
        return array(
            array('FooBundle:Post:index.html.twig.php', 'FooBundle:Post:index.html.twig.php', '@FooBundle/Resources/views/Post/index.html.twig.php', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'php')),
            ...
            array('SensioFooBundle:Post:index.html.twig.php', 'SensioFooBundle:Post:index.html.twig.php', '@SensioFooBundle/Resources/views/Post/index.html.twig.php', new TemplateReference('SensioFooBundle', 'Post', 'index', 'html', 'php')),
            array('SensioCmsFooBundle:Post:index.html.twig.php', 'SensioCmsFooBundle:Post:index.html.twig.php', '@SensioCmsFooBundle/Resources/views/Post/index.html.twig.php', new TemplateReference('SensioCmsFooBundle', 'Post', 'index', 'html', 'php')),
            array(':Post:index.html.twig.php', ':Post:index.html.twig.php', 'views/Post/index.html.twig.php', new TemplateReference('', 'Post', 'index', 'html', 'php')),
            array('::index.html.twig.php', '::index.html.twig.php', 'views/index.html.twig.php', new TemplateReference('', '', 'index', 'html', 'php')),
            array('index.html.twig.php', '::index.html.twig.php', 'views/index.html.twig.php', new TemplateReference('', '', 'index', 'html', 'php')),
            array('FooBundle:Post:foo.bar.index.html.twig.php', 'FooBundle:Post:foo.bar.index.html.twig.php', '@FooBundle/Resources/views/Post/foo.bar.index.html.twig.php', new TemplateReference('FooBundle', 'Post', 'foo.bar.index', 'html', 'php')),
            ...
            array('default/index.html.twig.php', '::default/index.html.twig.php', 'views/default/index.html.twig.php', new TemplateReference(null, null, 'default/index', 'html', 'php')),
        );
    }
    ...
    {
        $this->parser->parse('BarBundle:Post:index.html.twig.php');
    }
    ...
    {
        return array(
            array('/path/to/section/index.html.twig.php', '/path/to/section/index.html.twig.php', '/path/to/section/index.html.twig.php', new BaseTemplateReference('/path/to/section/index.html.twig.php', 'php')),
