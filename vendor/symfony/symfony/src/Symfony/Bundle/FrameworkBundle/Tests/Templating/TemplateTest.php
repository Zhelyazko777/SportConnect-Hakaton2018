...
class TemplateTest extends TestCase
{
    ...
    {
        return array(
            array(new TemplateReference('FooBundle', 'Post', 'index', 'html', 'php'), '@FooBundle/Resources/views/Post/index.html.twig.php'),
            array(new TemplateReference('FooBundle', '', 'index', 'html', 'twig'), '@FooBundle/Resources/views/index.html.twig'),
            array(new TemplateReference('', 'Post', 'index', 'html', 'php'), 'views/Post/index.html.twig.php'),
            array(new TemplateReference('', '', 'index', 'html', 'php'), 'views/index.html.twig.php'),
        );
    }
}
